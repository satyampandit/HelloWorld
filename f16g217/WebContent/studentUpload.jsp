...
<f:view>
	<h3 align="center">
			...
			<br/>
			<h:outputText value="Student Data Upload " />
		</h3>
		<hr>
		<br />
		<center>
			...
			<h:panelGrid columns="2">
				<h:outputText value="Course CRN for upload student data:" />
				...
				<h:outputLabel value="Select a file to upload student data:" />
    		 ...
    		 <br/><br/>
    		<h:panelGrid columns="2">
				<h:outputText rendered="#{uploadFileBean.renderStudentUploadMessage}" value="Status:" />
				<h:outputText rendered="#{uploadFileBean.renderStudentUploadMessage}" value="#{uploadFileBean.errorMessage}" styleClass="color-red"/>
				<h:outputText rendered="#{uploadFileBean.renderStudentUploadMessage}" value="Number of Columns:" />
				<h:inputText rendered="#{uploadFileBean.renderStudentUploadMessage}" value="#{uploadFileBean.columnCount}" />
				<h:outputText rendered="#{uploadFileBean.renderStudentUploadMessage}" value="Number of Rows:" />
				<h:inputText rendered="#{uploadFileBean.renderStudentUploadMessage}" value="#{uploadFileBean.rowCount}" />
			</h:panelGrid>
			<br/><br/>
				<div style="background-attachment: scroll; overflow:auto; height:400px; background-repeat: repeat">
					<t:dataTable value="#{uploadFileBean.studentResultSet}"
							 var="row"
							 rendered="#{uploadFileBean.renderStudentUploadMessage}"
							 ...
							 width="900">
						<t:columns var="col" value="#{uploadFileBean.studentColumnList}">
							<f:facet name="header">
